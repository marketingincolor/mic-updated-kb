<?php
/*
  Plugin Name: MIC Knowledgebase
  Plugin URI: 
  Description: An edited version of wp-knowledgebase
  Author: Adam Doe
  Version: 1.0.0
  Author URI: www.marketingincolor.com
...
function kbe_plugin_menu() {
    ...
    add_submenu_page('edit.php?post_type=kbe_knowledgebase', 'Settings', 'Settings', 'manage_options', 'kbe_options', 'kbe_options');
}
...
function mic_knowledgebase_scripts() {
    wp_enqueue_script( 'mic-boxes-handle', WP_KNOWLEDGEBASE . 'js/boxes.js', false, true );
    wp_enqueue_script('mic-tax-boxes-handle', WP_KNOWLEDGEBASE . 'js/taxonomy-blocks.js', false, true);
}
