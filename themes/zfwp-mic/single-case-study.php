<?php
/**
 * The template for displaying custom portfolio posts and attachments
 *
 * @package WordPress
...
<div class="row collapse medium-uncollapse">
	...
	<!--<div class="small-12 XYZcolumns" style="padding-left:8.5rem; padding-right:8.5rem;">-->
		...
		if ($this_category) :
		?>
			<div class="small-12 columns" style="text-align:left; font-size:0.75em; margin-bottom:1em;"> &laquo;&laquo; <a href="<?php echo $cat_path;?>">Back to <?php echo $this_category[0]->cat_name;?></a></div>
		<?php else : ?>
			<div class="small-12 columns" style="text-align:left; font-size:0.75em; margin-bottom:1em;"> </div>
		<?php endif; ?>
