<?php 
	global $pl_data, $theme_url, $paged, $wp_query;
	if (have_posts()) :?>
...
<div id="post_grids" class="masonry-container post_content clearfix masonry">
...
<script>	
	$j(document).ready(function(){ 
		...
		var $container = $j('#post_grids').masonry();
		var min_width = 300;
		$container.imagesLoaded( function(){
		  $container.masonry({
			...
			columnWidth: function(containerWidth) {
				...
				return box_width;
				//var box_width = (((containerWidth - 2*gutWidth)/3) | 0) ;
				//if (box_width < min_width) {box_width = (((containerWidth - gutWidth)/2) | 0);}
