		...
		<div class="post_item post_single white_box">
			...
			<?php 
				...
				<div class="large_thumb xthumb_hoverx">
						...
						<div class="img_wrapper"><!--<img src="<?php echo $new_image[0];?>" width="<?php echo $new_image[1];?>" height="<?php echo $new_image[2];?>" alt="<?php the_title_attribute();?>" class="post_top_element thumb" itemprop="image" />--><?php if ( has_post_thumbnail() ) {the_post_thumbnail('full', array( 'class' => 'post_top_element thumb' ));} ?></div>
				</div>
					<?php
					...
					//		$imagecontent = $attachment->post_content ;
					//	}
					//}
					?>
			...
			<?php $imagecontent = get_post(get_post_thumbnail_id())->post_content ; ?>
			<?php } else { ?>
			<?php $imagecontent = '' ; ?>
			<?php } ?>
			<div class="social_share <?php echo $title_top_class ;?>">
			<?php social_share();?><div class="img_credits"><?php echo $imagecontent;?></div>
			</div>
