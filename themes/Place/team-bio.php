...
<div id="leftContent">
	<div class="inner">
		<div class="post_item post_single white_box">
			...
			<h1><?php the_title(); ?></h1>
			<?php if (do_shortcode('[bio_title]') != '') { echo '<h3>'.do_shortcode('[bio_title]').'</h3>'; } else { echo ''; } ?>
		...
		<!-- comments php block removed, custom team bio page, single entry -->
	</div>
</div>
